#ifndef DATABASESVIEW_HPP
#define DATABASESVIEW_HPP
...
#define DATABASES_QUESTION_COUNT 15
#define ANSWER_COUNT 4    
#define BUFFER_SIZE 100  

class DatabasesView : public DatabasesViewBase
{
public:
    DatabasesView();
...
protected:
    ...
    static const char* questions[DATABASES_QUESTION_COUNT];
    static const char* answers[DATABASES_QUESTION_COUNT][ANSWER_COUNT];
