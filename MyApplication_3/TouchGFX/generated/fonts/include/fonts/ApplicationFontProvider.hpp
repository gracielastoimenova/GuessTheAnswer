...
struct Typography
{
    ...
    static const touchgfx::FontId SCORE = 5;
};
...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId TYPOGRAPHY_00 = 3; // verdana_31_4bpp
    static const touchgfx::FontId COUNTER = 4;       // verdanab_20_4bpp
    static const touchgfx::FontId SCORE = 5;         // verdanab_40_4bpp
